...
/* ── HERO ── */
.hero {
    background: linear-gradient(135deg,#080C14 0%,#0F1729 45%,#0D1020 100%);
...
.hero::before {
    ...
    background:
        radial-gradient(ellipse 60% 80% at 90% 20%, rgba(99,102,241,.12) 0%, transparent 60%),
        radial-gradient(ellipse 40% 50% at 10% 80%, rgba(34,211,238,.07) 0%, transparent 50%);
    pointer-events:none;
}
.hero-badge {
...
.hero-title {
    ...
    letter-spacing:-.02em; margin:0 0 12px; color:#F1F3FF;
}
.hero-title span {
...
.free-badge {
    ...
    text-transform:uppercase; color:#34D399; margin-left:12px;
}
